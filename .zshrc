...
alias veww="nvim ~/.config/eww/bar"
alias vsway="nvim ~/.config/sway/config"
alias vkitty="nvim ~/.config/kitty/kitty.conf"
alias vslides="nvim ~/Pictures/slides.sh"
alias vnvim="nvim ~/.config/nvim/"

#scripts
alias clr="clear && ~/Repos/pokemon-icat/pokemon-icat.sh"
~/Repos/pokemon-icat/pokemon-icat.sh
